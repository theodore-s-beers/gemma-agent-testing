...
1. Create a copy of `.env.example` named `.env` and paste in your API key(s) and/or set `LLM_PROVIDER` to your preferred provider (with suitable values for corresponding variables).
...
- [`openai_genai.py`](lib/openai_genai.py): 'translation' class from OpenAI interface to Google's interface
